                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="{{ asset($latest_product->image) }}" alt="" style="height: 280px;"/>
                                ...
                                <div class="product-carousel-price">
                                    <ins>{{$latest_product->selling_price}}</ins> <del>{{$latest_product->regular_price}}</del>
                                </div>
                            </div>
                            @endforeach
                        </div>
    ...
    <div class="maincontent-area">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <h2 class="section-title">{{$home_category->category_name}}</h2>
                        <div class="product-carousel">
                            @foreach($home_category->products as $product)
                                <div class="single-product">
                                    <div class="product-f-image">
